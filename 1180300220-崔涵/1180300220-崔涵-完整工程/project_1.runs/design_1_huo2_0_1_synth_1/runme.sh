...
HD_PWD='D:/360MoveData/Users/Hiperwe/Desktop/coded_lock/coded_lock.runs/design_1_huo2_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_huo2_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_huo2_0_1.tcl
