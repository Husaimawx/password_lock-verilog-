...
--               D:/360MoveData/Users/Hiperwe/Desktop/coded_lock/coded_lock.srcs/sources_1/bd/design_1/ip/design_1_clock_10_1_0/design_1_clock_10_1_0_sim_netlist.vhdl
...
entity design_1_clock_10_1_0_clock_10 is
  port (
    jin1 : out STD_LOGIC;
    a : out STD_LOGIC;
    b : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_clock_10_1_0_clock_10 : entity is "clock_10";
end design_1_clock_10_1_0_clock_10;

architecture STRUCTURE of design_1_clock_10_1_0_clock_10 is
  signal Q : STD_LOGIC;
  ...
  signal \^jin1\ : STD_LOGIC;
  signal jin1_i_1_n_0 : STD_LOGIC;
...
a_reg_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
g_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8F"
    )
        port map (
...
jin1_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF08"
    )
        port map (
...
jin1_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_clock_10_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    ce : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_clock_10_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_clock_10_1_0 : entity is "design_1_clock_10_1_0,clock_10,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_clock_10_1_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_clock_10_1_0 : entity is "clock_10,Vivado 2018.1";
end design_1_clock_10_1_0;

architecture STRUCTURE of design_1_clock_10_1_0 is
...
inst: entity work.design_1_clock_10_1_0_clock_10
     port map (
      a => a,
      b => b,
      c => c,
